...
public class PoseUpdater {
     ...
     * Turning either directing increments this value
     ...
     * This is better suited for tuning using multiple rotations at once.
     * ('expected'-'actual' / ('number of rotations' * 6.28318531)) + 1
     * @return the current radian value from diffing each rotational direction
     */
    public double getRotationalChange() {
        return localizer.getRotationalChange();
    }
