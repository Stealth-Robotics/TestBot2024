...
public class FollowerConstants {
    ...
    public static String sensorName = "sparkOtos";
    ...
    public static double mass = 9.35942;
    ...
    public static double forwardZeroPowerAcceleration = -51.637; // -38.7776 LOW // -51.637 FULL;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -90.7; // 90.7 FULL
