 ...
 */
@Config
@TeleOp(group = "Tuning", name = "Localization Test")
public class LocalizationTest extends OpMode {
    ...
    public void init() {
        ...
        poseUpdater.setStartingPose(new Pose(8, 8, 0));
    ...
    public void loop() {
        ...
        telemetryA.addData("Total of Rotation", poseUpdater.getRotationalChange());
        telemetryA.update();
